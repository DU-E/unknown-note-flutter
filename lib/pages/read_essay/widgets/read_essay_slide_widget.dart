...
class ReadEssaySlideWidget extends StatefulWidget {
  final bool isWriter;

  const ReadEssaySlideWidget({
    super.key,
    required this.isWriter,
  });

  @override
  State<ReadEssaySlideWidget> createState() => _ReadEssaySlideWidgetState();
}

class _ReadEssaySlideWidgetState extends State<ReadEssaySlideWidget>
